...
namespace EventPl.Services.Interface
{
    ...
    public interface IDiscussionsService
    {
        ...
        /// <summary>
        /// الحصول على جميع نقاشات الحدث مع الردود مع تمرير نسخة الحدث (Ticks) لاستخدامها في المفتاح المؤقت
        /// </summary>
        Task<List<DiscussionDto>> GetEventDiscussionsAsync(Guid eventId, long? eventVersionTicks);
