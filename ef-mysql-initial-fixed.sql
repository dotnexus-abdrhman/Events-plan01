...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20251010235109_InitialMySqlFixed') THEN
...
BEGIN
    ...
    CREATE TABLE `Events` (
        ...
        `Status` varchar(255) CHARACTER SET utf8mb4 NOT NULL DEFAULT 'Draft',
...
BEGIN
    ...
    CREATE TABLE `AttendanceLogs` (
        ...
        `AttendanceType` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
...
BEGIN
    ...
    CREATE TABLE `EventParticipants` (
        ...
        `Status` varchar(255) CHARACTER SET utf8mb4 NOT NULL DEFAULT 'Invited',
...
BEGIN
    ...
    VALUES ('20251010235109_InitialMySqlFixed', '9.0.9');
